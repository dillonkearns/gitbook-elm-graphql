...
We could have given any function here that takes an `Int` as the argument. Using the constructor functions that are generated when we declare type aliases of records is handy
